...
- [Typed properties & templates design](project_typed_properties.md) — Template-driven typing, primitive values; templates are first-class state so diff/history must reflect template changes; Phase 1 done on feat/typed-properties-templates
